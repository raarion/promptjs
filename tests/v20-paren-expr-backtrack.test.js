 ...
 *
 * Root cause: _parsePrimaryExpression's arrow-function probe saved/restored
 * this._pos, but the parser's real cursor field is this.pos. When the first
 * token after `(` was an identifier, a failed arrow probe advanced the parser
 * and the parenthesized-expression path resumed from the wrong token.
 */
